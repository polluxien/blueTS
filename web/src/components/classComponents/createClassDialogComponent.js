...
function CreateClassDialogComponent({ cls }) {
      ...
      <div className="modal show" style={{ display: "block", position: "initial" }}>
        <Modal.Dialog>
          ...
          <Modal.Body>
            ...
            {classVariables && classVariables.length > 0 && (<Form 
        //validated={validated}
        onSubmit={handleSubmit}>
                {classVariables.map((param, index) => (<FormGroup key={index}>
                    <Form.Label>
...
//# sourceMappingURL=createClassDialogComponent.js.map